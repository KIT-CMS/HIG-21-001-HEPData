...
do
    ./create_1D_vlq_scans_yaml.py \
        --inputs "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_mU${m}000_combined.json:Combined" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_mU${m}000_nobtag.json:No b tag" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_mU${m}000_btag.json:b tag" \
...
do
    ./create_1D_vlq_scans_yaml.py \
        --inputs "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_minus1_mU${m}000_combined.json:Combined" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_minus1_mU${m}000_nobtag.json:No b tag" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_minus1_mU${m}000_btag.json:b tag" \
...
do
    ./create_1D_vlq_scans_yaml.py \
        --inputs "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_offdiag0_mU${m}000_combined.json:Combined" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_offdiag0_mU${m}000_nobtag.json:No b tag" \
                 "data/vlq_hep_data/scans_v3/vlq_scan_betaRd33_0_offdiag0_mU${m}000_btag.json:b tag" \
